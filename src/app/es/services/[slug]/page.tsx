...
import { getServicePageContent, getAllServicePageSlugs } from "@/lib/content/es/service-pages";
import {
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `${baseUrl}/es/services/${slug}`,
      languages: {
        'en-US': `${baseUrl}/services/${slug}`,
        'es-ES': `${baseUrl}/es/services/${slug}`,
      },
    },
  };
}

export default async function SpanishServiceDetailPage({ params }: Props) {
  const { slug } = await params;
  const content = getServicePageContent(slug);
  ...
  const faqSchema = generateFAQSchema(content.faqs, 'es');
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    {
      name: content.name,
      url: `https://mobile-notary-management.com/es/services/${slug}`,
    },
  ], 'es');
    ...
    <>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto max-w-3xl px-4">
          <h2 className="text-3xl font-bold tracking-tight mb-6">Descripción General</h2>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto max-w-3xl px-4">
          ...
          <p className="text-muted-foreground text-center mb-10">
            Preguntas comunes sobre servicios de {content.name.toLowerCase()}.
          </p>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {content.relatedCitySlugs.map((citySlug) => {
                ...
                return (
                  <Link
                    key={citySlug}
                    href={`/es/mobile-notary-${citySlug}`}
